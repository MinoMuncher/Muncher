...
namespace Minomuncher
{
    public partial class TREstimator
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"Glicko", @"Glicko")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Glicko"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=0.813847F,LabelColumnName=@"TR",FeatureColumnName=@"Features"}));
